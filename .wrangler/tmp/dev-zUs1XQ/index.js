...
// .wrangler/tmp/bundle-zGE45R/checked-fetch.js
...
var getDaysSinceLastFed = /* @__PURE__ */ __name((lastFedAt) => {
  if (!lastFedAt) {
...
async function handleUpdateThresholds(db, request, classId) {
  ...
  await appendLog(db, {
    ...
    userId,
    actionType: "\u89C4\u5219\u4FEE\u6539",
    detail: `\u66F4\u65B0\u4E86\u7B49\u7EA7\u9608\u503C\uFF1A${thresholds.join(" / ")}\uFF1B\u5BA0\u7269\u72B6\u6001\u9608\u503C\uFF1A${petConditionConfig.hungry_days}/${petConditionConfig.weak_days}/${petConditionConfig.sleeping_days} \u5929\uFF1B\u65E5\u8870\u51CF\uFF1A${petConditionConfig.hungry_decay}/${petConditionConfig.weak_decay}/${petConditionConfig.sleeping_decay} EXP`
  });
  return json({
...
// .wrangler/tmp/bundle-zGE45R/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-zGE45R/middleware-loader.entry.ts
